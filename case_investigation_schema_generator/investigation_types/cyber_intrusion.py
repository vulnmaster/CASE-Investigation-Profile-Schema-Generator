    ...
    def _init_cyber_classes(self):
        ...
        self.classes.update({
            ...
            "Artifact": CaseClass(
                ...
                properties=["mime_type", "payload_bin", "url", "hashes", "encryption_algorithm"]
            ),
            ...
            "EmailMessage": CaseClass(
                ...
                superclasses=["observable:Observable"],
                properties=[
                    "is_multipart", "date", "content_type", "from_ref", "sender_ref",
                    "to_refs", "cc_refs", "bcc_refs", "subject", "received_lines",
                    "additional_header_fields", "body", "body_multipart", "raw_email_ref"
                ]
            ),
            "File": CaseClass(
                name="File",
                ...
                superclasses=["observable:Observable"],
                properties=[
                    "hashes", "size", "name", "name_enc", "magic_number_hex", "mime_type",
                    "created", "modified", "accessed", "parent_directory_ref", "content_ref",
                    "is_encrypted", "encryption_algorithm", "decryption_key"
                ]
            ),
            ...
            "NetworkTraffic": CaseClass(
                ...
                superclasses=["observable:Observable"],
                properties=[
                    "start", "end", "is_active", "src_ref", "dst_ref", "src_port",
                    "dst_port", "protocols", "src_byte_count", "dst_byte_count",
                    "src_packets", "dst_packets", "ipfix", "src_payload_ref",
                    "dst_payload_ref", "encapsulates_refs", "encapsulated_by_ref"
                ]
            ),
            ...
            "Indicator": CaseClass(
                ...
                superclasses=["observable:Observable"],
                properties=[
                    "pattern", "pattern_type", "pattern_version", "valid_from",
                    "valid_until", "kill_chain_phases"
                ]
            )
        })
