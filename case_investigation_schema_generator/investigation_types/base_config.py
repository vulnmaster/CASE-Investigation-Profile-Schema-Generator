    ...
    def _init_core_classes(self):
        ...
        self.classes.update({
            "UcoObject": CaseClass(
                ...
                properties=["createdBy", "description", "externalReference", "hasFacet", 
                          "modifiedTime", "name", "objectCreatedTime", "specVersion", "tag"]
            ),
            "Investigation": CaseClass(
                ...
                properties=["investigativeActions", "subjects", "provenance", 
                          "observables", "physicalEvidence", "deviceEvidence", 
                          "systemMonitoring", "userActivity", "victimIdentification"]
            )
        })
