    ...
    def _init_murder_classes(self):
        ...
        self.classes.update({
            "CrimeScene": CaseClass(
                ...
                properties=[
                    "latitude", "longitude", "address", "sceneType",
                    "securitySystems", "accessPoints", "digitalDevicesPresent"
                ]
            ),
            "PhysicalEvidence": CaseClass(
                ...
                properties=[
                    "evidenceType", "chainOfCustody", "collectionLocation",
                    "forensicAnalysis", "digitalDocumentation"
                ]
            ),
            "VictimDevice": CaseClass(
                ...
                properties=[
                    "deviceType", "owner", "lastAccessed", "dataExtracted",
                    "encryptionStatus", "relevantFiles", "communicationHistory"
                ]
            ),
            "DigitalCommunication": CaseClass(
                ...
                properties=[
                    "communicationType", "sender", "recipient", "timestamp",
                    "content", "platform", "relevance", "threatContent"
                ]
            ),
            "LocationHistory": CaseClass(
                ...
                superclasses=["location:Location"],
                properties=[
                    "device", "timestamp", "coordinates", "accuracy",
                    "source", "activity", "correlatedEvents"
                ]
            ),
            "OnlineActivity": CaseClass(
                ...
                properties=[
                    "searchTerms", "visitedURLs", "timestamp", "device",
                    "accountUsed", "relevantSearches", "suspiciousActivity"
                ]
            ),
            "SurveillanceData": CaseClass(
                ...
                properties=[
                    "systemType", "location", "timeRange", "capturedEvents",
                    "dataFormat", "relevantFootage", "retentionPeriod"
                ]
            )
        })
