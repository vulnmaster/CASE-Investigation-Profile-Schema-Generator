...
def test_murder_investigation_schema():
    ...
    assert properties["physicalEvidence"]["items"]["allOf"][1]["properties"]["@type"]["const"] == "case:PhysicalEvidence"
...
def test_child_abuse_investigation_schema():
    ...
    assert properties["digitalEvidence"]["items"]["allOf"][1]["properties"]["@type"]["const"] == "case:DigitalEvidence"
...
def test_insider_threat_investigation_schema():
    ...
    assert properties["systemMonitoring"]["items"]["allOf"][1]["properties"]["@type"]["const"] == "case:SystemMonitoring"
