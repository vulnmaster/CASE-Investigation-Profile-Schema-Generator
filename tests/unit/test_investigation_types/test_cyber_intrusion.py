import pytest
from case_investigation_schema_generator.investigation_types.cyber_intrusion import CyberIntrusionConfig
...
def test_stix_mapping():
    ...
    assert "NetworkTraffic" in config.classes
    network_traffic = config.classes["NetworkTraffic"]
    assert network_traffic.uri == "https://ontology.unifiedcyberontology.org/uco/observable/NetworkTraffic"
    ...
    assert indicator.uri == "https://ontology.caseontology.org/case/investigation/Indicator"
