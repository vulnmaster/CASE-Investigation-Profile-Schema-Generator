...
def test_role_classes():
    ...
    assert attorney.uri == "https://ontology.caseontology.org/case/investigation/Attorney"
    ...
    assert examiner.uri == "https://ontology.caseontology.org/case/investigation/Examiner"
