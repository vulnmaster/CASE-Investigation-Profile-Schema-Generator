...
from case_investigation_schema_generator.investigation_types.insider_threat_investigation import (
    InsiderThreatConfig,
)
...
def test_detection_tools():
    ...
    assert (
        detection_tool.uri == "https://ontology.unifiedcyberontology.org/uco/tool/Tool"
    )
