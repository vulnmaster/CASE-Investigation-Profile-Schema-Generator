import pytest
from case_investigation_schema_generator.investigation_types.child_abuse_investigation import ChildAbuseConfig
...
def test_device_evidence_mapping():
    ...
    assert offender_device.uri == "https://ontology.unifiedcyberontology.org/uco/observable/Device"
    ...
    assert digital_comm.uri == "https://ontology.unifiedcyberontology.org/uco/observable/Message"
