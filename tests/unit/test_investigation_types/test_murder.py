import pytest
from case_investigation_schema_generator.investigation_types.murder_investigation import MurderConfig
...
def test_digital_evidence_mapping():
    ...
    assert victim_device.uri == "https://ontology.unifiedcyberontology.org/uco/observable/Device"
