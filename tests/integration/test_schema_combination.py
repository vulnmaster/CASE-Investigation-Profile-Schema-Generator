...
def test_combine_cyber_and_murder():
    ...
    assert cyber_schema["properties"]["createdBy"] == murder_schema["properties"]["createdBy"]
    assert cyber_schema["properties"]["modifiedTime"] == murder_schema["properties"]["modifiedTime"]
