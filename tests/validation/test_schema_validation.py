...
def test_required_properties():
    ...
    schema["definitions"]["string"] = {"type": "string"}
    schema["definitions"]["xsd_dateTime"] = {"type": "string", "format": "date-time"}
...
def test_circular_reference_handling():
    ...
    assert (
        instance["createdBy"]["createdBy"]["createdBy"]["@type"]
        == "core:IdentityAbstraction"
    )
    assert (
        instance["createdBy"]["createdBy"]["createdBy"]["objectCreatedTime"]
